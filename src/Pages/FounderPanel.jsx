...
//         <style>{founderStyles}</style>
//         <Alert variant="danger" className="lab-terminal border-0 shadow-sm">
//           <strong>FOUNDER_PANEL_ERROR:</strong> {error}
//         </Alert>
//       </Container>
//     )
//   }
...
//         <div className="d-flex align-items-center gap-3">
//           <span className="text-muted small">Last Sync: {lastUpdated}</span>
//           <Button
//             variant="link"
//             className="refresh-button text-decoration-none"
//             onClick={refreshData}
...
//                 <Col md={6}>
//                   <div className="id-check-row">
//                     <div className="small text-muted text-uppercase fw-bold">Founder Wallet Count</div>
//                     <div className="fw-bold" style={{ fontFamily: 'monospace' }}>
//                       {founderWallets.length}
//                     </div>
//                   </div>
...
//                   <div className="id-check-row">
//                     <div className="small text-muted text-uppercase fw-bold">Total Founder Ratio</div>
//                     <div className="fw-bold" style={{ fontFamily: 'monospace' }}>
//                       {(totalRatio / 100).toFixed(2)}%
//                     </div>
//                   </div>
...
//         <Col>
//           <div className="lab-terminal">
//             <div className="terminal-header">[ Founder Summary ]</div>
//             <div className="p-4 pulse-overlay">
//               <Row>
//                 <Col md={6} className="mb-3 mb-md-0">
//                   <div className="small text-muted text-uppercase fw-bold">Total Tracked Founder Balances</div>
//                   <div className="fw-bold" style={{ fontFamily: 'monospace', fontSize: '1.4rem', color: '#002366' }}>
//                     {totalFounderBalance.toFixed(2)} USDT
//                   </div>
//                 </Col>
...
//                 <Col md={6}>
//                   <div className="small text-muted text-uppercase fw-bold">Distribution Rule</div>
//                   <div className="fw-bold" style={{ color: '#002366' }}>
//                     Founder payouts follow the ratios configured in LevelManager.
//                   </div>
//                   <div className="small text-muted mt-1">
//                     If all 8 wallets are set to 1250 each, distribution is equal at 12.5% each.
//                   </div>
//                 </Col>
//               </Row>
//             </div>
...
//                     <tr>
//                       <td colSpan={3} className="text-center text-muted">
//                         Founder wallets not configured yet.
//                       </td>
//                     </tr>
//                   ) : (
//                     founderWallets.map((wallet, index) => (
...
//               <div className="p-3 border-top bg-light">
//                 <p className="text-muted m-0 small fw-bold">
//                   <span className="text-primary">PROTOCOL_NOTE:</span> Funds routed to founders through the ID1/founder path are distributed according to the ratios currently stored in the LevelManager contract.
//                 </p>
//               </div>
//             </div>
//           </div>
