...
//           <div style={{ height: '30px', width: '6px', background: '#002366', marginRight: '15px' }}></div>
//           <h1 className="m-0 fw-black text-uppercase" style={{ color: '#002366', letterSpacing: '1px', fontSize: '1.8rem' }}>
//             {isRegistered ? 'System Levels' : 'System Registration'}
//           </h1>
//           {isDeployer && <span className="deployer-badge">DEPLOYER</span>}
//         </div>
//         <div className="d-flex align-items-center">
//           <span className="text-muted small me-3">Last Sync: {lastUpdated}</span>
//           <Button
//             variant="link"
//             className="refresh-button"
//             onClick={refreshData}
...
//       {txStatus.hash && (
//         <Alert variant="info" className="mb-4 status-node border-0 shadow-sm">
//           <strong>BROADCASTING_TX:</strong>{' '}
//           <a href={`https://amoy.polygonscan.com/tx/${txStatus.hash}`} target="_blank" rel="noopener noreferrer" className="text-decoration-none">
//             {txStatus.hash}
//           </a>
//         </Alert>
//       )}
...
//                   <div className="small text-muted fw-bold text-uppercase d-flex align-items-center">
//                     Liquid Assets
//                     <span className="tooltip-icon" data-tooltip="Your USDT balance for activating levels">?</span>
//                   </div>
//                   <div className="fw-bold" style={{ color: '#002366' }}>
//                     {usdtBalance} <span className="small">USDT</span>
//                   </div>
...
//                   <div className="small text-muted fw-bold text-uppercase d-flex align-items-center">
//                     Manager Allowance
//                     <span className="tooltip-icon" data-tooltip="Amount approved for LevelManager to spend">?</span>
//                   </div>
//                   <div className="fw-bold" style={{ color: '#002366' }}>
//                     {allowance} <span className="small">USDT</span>
//                   </div>
...
//                     </Row>
//                     <div className="small text-muted mt-2">
//                       Transfer USDT from deployer treasury to your current address.
//                     </div>
//                   </>
//                 ) : (
//                   <>
...
//                     </Row>
//                     <div className="small text-muted mt-2">
//                       Transfer USDT from deployer treasury to any test address.
//                     </div>
//                   </>
//                 )}
//               </div>
...
//                   <p className="mt-2 mb-0 small">
//                     You need USDT to activate levels. Since this is testnet, request USDT from the deployer wallet.
//                   </p>
//                 </Alert>
//               </div>
//             </div>
...
//           {!isRegistered && (
//             <div className="lab-terminal mb-4">
//               <div className="terminal-header">[ INITIALIZE_HANDSHAKE ]</div>
//               <div className="p-4">
//                 <Form>
//                   <Form.Group className="mb-4">
...
//           <div className="lab-terminal mb-4">
//             <div className="terminal-header">{isRegistered ? '[ LEVELS_ACTIVATION ]' : '[ UPGRADE_CIPHER_LEVEL ]'}</div>
//             <div className="p-4">
//               {!isRegistered ? (
//                 <Alert variant="info" className="mb-0">
//                   <strong>Registration required first</strong>
//                   <p className="mt-2 mb-0 small">
//                     Complete registration above before activating levels.
//                   </p>
//                 </Alert>
//               ) : (
//                 <>
