...
export const Dashboard = () => {
  ...
  const dashboardStyles = `
    ...
    @media (hover: hover) and (pointer: fine) {
      .royal-card:hover {
        ...
        box-shadow: 0 18px 42px rgba(0, 35, 102, 0.14);
      }
  ...
  return (
    <Container className="dashboard-shell mt-5 pt-5 pb-5">
      <style>{dashboardStyles}</style>
      ...
      <div className="animate-fade">
        ...
        <div className="dashboard-hero mb-5 p-4 rounded-4 shadow-sm bg-white d-flex justify-content-between align-items-center">
          <div className='mt-4'>
            ...
            <div className="d-flex align-items-center mt-2 ms-3">
              ...
              <span className="text-muted small fw-bold dashboard-address" style={{ fontFamily: 'monospace' }}>
            ...
            {scrollItems.map((level, index) => {
              ...
              return (
                <div key={index} className={`royal-card ${isActive ? 'level-active' : ''}`}>
                  <div className="pulse-bg p-4 text-center h-100 w-100 dashboard-card-inner">
        ...
        <Row className="mb-5">
          <Col lg={6} md={6} className="mb-4">
            <div className="royal-card h-100 fee-card nft">
              <div className="pulse-bg p-4 h-100 w-100 dashboard-card-inner">
                ...
                <h2 className="fw-bold mb-2 dashboard-balance" style={{ color: '#002366', fontFamily: 'monospace', fontSize: '2.2rem' }}>
                ...
                <div className="mb-3 p-2 bg-light rounded-3">
                  <div className="d-flex justify-content-between small gap-2 flex-wrap">
                ...
                <div className="small text-muted mt-2 dashboard-mono" style={{ fontSize: '0.7rem', wordBreak: 'break-all' }}>
          ...
          <Col lg={6} md={6} className="mb-4">
            <div className="royal-card h-100 fee-card ops">
              <div className="pulse-bg p-4 h-100 w-100 dashboard-card-inner">
                ...
                <h2 className="fw-bold mb-2 dashboard-balance" style={{ color: '#28a745', fontFamily: 'monospace', fontSize: '2.2rem' }}>
        ...
        <Row className="mb-5">
          <Col>
            <div className="royal-card p-4 dashboard-total-card">
              <div className="d-flex justify-content-between align-items-center dashboard-total-row">
                <div>
                  <h5 className="mb-1">{t('dashboard.totalFeesCollected')}</h5>
                  <h2 className="fw-bold dashboard-balance" style={{ color: '#002366' }}>{totalFeesCollected} {t('dashboard.usdt')}</h2>
                  <div className="small text-muted">
                    {t('dashboard.feeSplit')}
                  </div>
                </div>
                <div className="text-end dashboard-total-right">
            ...
            return (
              <Col lg={4} md={6} key={name} className="mb-4">
                <div className="royal-card h-100">
                  <div className="pulse-bg p-4 h-100 w-100 dashboard-card-inner">
                    <div className="d-flex justify-content-between align-items-center border-bottom border-light pb-2 mb-3 gap-2">
                    ...
                    <h2 className="fw-bold m-0 dashboard-balance" style={{ color: '#002366', fontFamily: 'monospace' }}>
