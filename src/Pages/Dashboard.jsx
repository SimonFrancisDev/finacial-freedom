...
//   //     let participantCount = id1Wallet && id1Wallet !== ethers.ZeroAddress ? 1 : 0

//   //     if (contracts.registration.filters?.Registered) {
//   //       try {
//   //         const latestBlock = await contracts.registration.runner.provider.getBlockNumber()
//   //         const step = 5000
//   //         const uniqueParticipants = new Set()

//   //         for (let fromBlock = 0; fromBlock <= latestBlock; fromBlock += step + 1) {
//   //           const toBlock = Math.min(fromBlock + step, latestBlock)
//   //           const events = await contracts.registration.queryFilter(
//   //             contracts.registration.filters.Registered(),
//   //             fromBlock,
//   //             toBlock
//   //           )
...
//   //             if (user) {
//   //               uniqueParticipants.add(user.toLowerCase())
//   //             }
//   //           })
//   //         }
...
//   //       } catch (eventErr) {
//   //         console.error('Event-based participant count failed:', eventErr)
//   //       }
//   //     }
...
//       if (!window.ethereum) return
//       const chainId = await window.ethereum.request({ method: 'eth_chainId' })
//       setNetworkWarning(chainId !== AMOY_CHAIN_ID ? 'Protocol Mismatch: Switch to Polygon Amoy Core' : '')
//     }
...
//         <style>{dashboardStyles}</style>
//         <Spinner animation="grow" variant="primary" />
//         <p className="mt-3 fw-bold text-muted" style={{ letterSpacing: '2px' }}>LOADING DASHBOARD...</p>
//       </Container>
//     )
//   }
...
//           </div>
//           <div className="text-end">
//             <div className="small fw-bold text-uppercase text-muted">Last Sync: {lastUpdated}</div>
//             <Button
//               variant="link"
//               className="refresh-button mt-1"
//               onClick={refreshData}
...
//         <h2 className="section-title mb-4">📊 Fee Distribution (10% System Charge)</h2>
//         <Row className="mb-5">
//           <Col lg={6} md={6} className="mb-4">
//             <div className="royal-card h-100 fee-card nft">
//               <div className="pulse-bg p-4 h-100 w-100">
...
//                     🎨 NFT POOL
//                   </span>
//                   <span className="badge bg-primary">80% of Fees</span>
//                 </div>

//                 <h2 className="fw-bold mb-2" style={{ color: '#002366', fontFamily: 'monospace', fontSize: '2.2rem' }}>
//                   {parseFloat(nftPoolBalance || '0').toLocaleString(undefined, { minimumFractionDigits: 2 })}
//                   <small className="text-muted" style={{ fontSize: '0.8rem' }}> USDT</small>
//                 </h2>

//                 <div className="mb-3 p-2 bg-light rounded-3">
//                   <div className="d-flex justify-content-between small">
//                     <span>Accumulated since last reset:</span>
//                     <span className="fw-bold text-success">+{feesSinceLastCheck.nft} USDT</span>
//                   </div>
//                   <ProgressBar
//                     now={parseFloat(feesSinceLastCheck.nft) > 0 ? 100 : 0}
//                     variant="info"
...
//                 <div className="small text-muted mt-2" style={{ fontSize: '0.7rem', wordBreak: 'break-all' }}>
//                   <span className="fw-bold">Address:</span> {nftPoolAddress}
//                 </div>
//                 <div className="small text-muted mt-1">
//                   <span className="fw-bold">Purpose:</span> Platform development & community rewards
//                 </div>
//               </div>
//             </div>
//           </Col>
...
//                     ⚙️ OPERATIONS WALLET
//                   </span>
//                   <span className="badge bg-success">20% of Fees</span>
//                 </div>
...
//                   <div className="d-flex justify-content-between small">
//                     <span>Accumulated since last reset:</span>
//                     <span className="fw-bold text-success">+{feesSinceLastCheck.ops} USDT</span>
//                   </div>
//                   <ProgressBar
//                     now={parseFloat(feesSinceLastCheck.ops) > 0 ? 100 : 0}
//                     variant="success"
...
//                 <div className="small text-muted mt-2" style={{ fontSize: '0.7rem', wordBreak: 'break-all' }}>
//                   <span className="fw-bold">Address:</span> {opsWalletAddress}
//                 </div>
//                 <div className="small text-muted mt-1">
//                   <span className="fw-bold">Purpose:</span> Server costs, maintenance, operations
//                 </div>
//               </div>
//             </div>
//           </Col>
...
//               <div className="d-flex justify-content-between align-items-center">
//                 <div>
//                   <h5 className="mb-1">💰 Total Fees Collected</h5>
//                   <h2 className="fw-bold" style={{ color: '#002366' }}>{totalFeesCollected} USDT</h2>
//                   <div className="small text-muted">
//                     80% NFT Pool · 20% Operations
//                   </div>
//                 </div>
//                 <div className="text-end">
//                   <div className="accumulation-badge mb-2">
//                     ⚡ +{feesSinceLastCheck.total} since last reset
//                   </div>
//                   <Button
//                     variant="outline-secondary"
//                     size="sm"
...
//                       {parseFloat(balance || '0').toLocaleString(undefined, { minimumFractionDigits: 2 })}
//                     </h2>
//                     <div className="small fw-bold text-muted mt-1">USDT</div>

//                     {name === 'LEVEL_MANAGER' && (
//                       <div className="small text-info mt-2">
//                         ⏳ Temporarily holds funds during activation
//                       </div>
//                     )}

//                     {name === 'ESCROW' && (
//                       <div className="small text-info mt-2">
//                         🔒 Locked funds for user auto-upgrades
//                       </div>
//                     )}
//                   </div>
//                 </div>
...
//                     <span className="tooltip-icon" data-tooltip="Registered participants plus Founder ID / ID1">?</span>
//                   </span>
//                   <span className="badge rounded-pill bg-primary" style={{ fontSize: '0.6rem' }}>Real Data</span>
//                 </div>
...
//                   {totalParticipants.toLocaleString()}
//                 </h2>
//                 <div className="small fw-bold text-muted mt-1">{totalParticipants.toLocaleString() == "1" ? "PARTICIPANT" : "PARTICIPANTS"}</div>

//                 <div className="small text-info mt-2">
//                   👥 Includes Founder ID / ID1
//                 </div>
//               </div>
//             </div>
//           </Col>
